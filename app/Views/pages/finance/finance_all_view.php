...
<section class="space-y-2">
    ...
    <h2 class="text-center font-semibold text-2xl">Semua Riwayat</h2>
    <div class="overflow-auto p-3 border rounded-md" style="height: calc(80dvh - 5rem);">
        <table class="w-full border border-black">
            ...
            <tbody class="" style="min-height:calc(80dvh - 9rem);">
                <?php
                if (is_array($transactions) && count(
                    $transactions
                ) > 0) {
                ...
                ?>
                        <tr>
                            ...
                            <td class="border border-black"> <?= esc($trans['desc']) ?> </td>
                            <td class="border border-black"> <?= esc($trans['created_by']) ?> </td>
                            <td class="border border-black"> <?= date('d/m/Y H:i', strtotime(esc($trans['created_at']))) ?></td>
                            <td class="border border-black"> <?= esc($trans['type']) ?></td>
                            <td class="border border-black">
                                <span class="font-semibold" style="color: <?= $trans['type_id'] == App\Enums\TransactionTypeEnum::INCOME ? "#22c55e" : "#ef4444" ?>;"><?= $fmt->formatCurrency(esc($trans['amount']), 'IDR') ?></span>
                            </td>
                            <?php if (session()->get('role') == RoleEnum::ACCOUNTING): ?>
                                <td class="border border-black">
                                    <div class="flex gap-2 ">
                                        <a href="<?= base_url('a/admin/finances/edit/') . $trans['id'] ?>" data-type="button" class="bg-sky-300 inline-block p-1">
                                        ...
                                        <a href="<?= base_url('a/admin/finances/delete/') . $trans['id'] ?>" data-type="button" class="bg-red-400 inline-block p-1">
                                            <div class="flex gap-1 items-center">
                    ...
                    <tr class="border border-black">
                        ...
                        <td class="border border-black text-left" colspan="2">
                            <span class="font-bold text-red-500">
                                <?= $fmt->formatCurrency(esc($total), 'IDR') ?>
                            </span>
                        </td>
                    </tr>
                <?php } else { ?>
        ...
        <div class="my-3 flex justify-end">
            <a href="<?= current_url() . "/report" ?>" data-type="button" class="bg-sky-300 inline-block p-2">
                <div class="flex gap-1 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 -960 960 960" width="18px" fill="#000">
                        <path d="M216-216h51l375-375-51-51-375 375v51Zm-72 72v-153l498-498q11-11 23.84-16 12.83-5 27-5 14.16 0 27.16 5t24 16l51 51q11 11 16 24t5 26.54q0 14.45-5.02 27.54T795-642L297-144H144Zm600-549-51-51 51 51Zm-127.95 76.95L591-642l51 51-25.95-25.05Z" />
                    </svg>
