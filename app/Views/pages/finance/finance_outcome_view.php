...
<section class="space-y-2">
    ...
    <h2 class="text-center font-semibold text-2xl">Outcome/Pengeluaran</h2>
            ...
            <tbody class="" style="min-height:calc(80dvh - 9rem);">
                ...
                ?>
                        <tr>
                            ...
                            <td class="border border-black"> <?= esc($outcome['created_by']) ?> </td>
                            <td class="border border-black"> <?= date('d/m/Y H:i', strtotime(esc($outcome['created_at']))) ?></td>
                            <td class="border border-black"> <span class="font-semibold"><?= $fmt->formatCurrency(esc($outcome['amount']), 'IDR') ?></span></td>
                            <td class="border border-black">
                                <div class="flex gap-2 ">
                                    <a href="<?= base_url('a/admin/finances/edit/') . $outcome['id'] ?>" data-type="button" class="bg-sky-300 inline-block p-1">
                                    ...
                                    <a href="<?= base_url('a/admin/finances/delete/') . $outcome['id'] ?>" data-type="button" class="bg-red-400 inline-block p-1">
                                        <div class="flex gap-1 items-center">
